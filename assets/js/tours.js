export const tours = [
    ...
    },
    {
        ...
        groupSize: { es: "Max 5 personas", en: "Max 5 people" },
        type: { es: "Privado", en: "Private" },
        location: "Dique Río Rejo, Cajamarca",
        title: { es: "Dique Río Rejo", en: "Rio Rejo Dam" },
        description: { es: "Un paraíso paisajístico rodeado de inmensos bosques de pinos y una serena laguna turquesa.", en: "A scenic paradise surrounded by immense pine forests and a serene turquoise lagoon." },
        fullDescription: { es: "El Dique Río Rejo es el lugar perfecto para desconectarse. Disfruta de caminatas entre bosques de pinos y fotografía la belleza de su reservorio. Un destino tranquilo ideal para amantes de la naturaleza.", en: "The Rio Rejo Dam is the perfect place to disconnect. Enjoy hikes through pine forests and photograph the beauty of its reservoir. A quiet destination ideal for nature lovers." },
        highlights: { es: ["Bosque de Pinos", "Laguna Turquesa", "Senderismo", "Fotografía"], en: ["Pine Forest", "Turquoise Lagoon", "Hiking", "Photography"] },
        includes: { es: ["Transporte privado", "Guía", "Entradas"], en: ["Private transport", "Guide", "Tickets"] },
        notIncluded: { es: ["Almuerzo"], en: ["Lunch"] },
        itinerary: [],
        faq: []
